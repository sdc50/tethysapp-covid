    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.covid"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.covid.tests.tests"

        To run tests in the CovidTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.covid.tests.tests.CovidTestCase"

        To run only the test_if_tethys_platform_is_great function in the CovidTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.covid.tests.tests.CovidTestCase.test_if_tethys_platform_is_great"
...
class CovidTestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(Covid)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(Covid)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/covid/')  # The final '/' is essential for all pages/controllers
